...
export const CompassIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        aria-label="Khám phá"
...
export const CompassActiveIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        aria-label="Khám phá"
...
export const WatchActiveIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        fill="currentColor"
...
export const PlusActiveIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        aria-label="Bài viết mới"
...
export const MenuActiveIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        fill="currentColor"
...
export const UserPlus = ({ width = '2.4rem', height = '2.4rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        aria-label=""
